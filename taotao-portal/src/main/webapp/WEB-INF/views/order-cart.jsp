...
<form id="orderForm" class="hide">
		...
		<input type="hidden" name="orderShipping.receiverName" value="张飞"/>
		...
		<input type="hidden" name="orderShipping.receiverAddress" value="北京市昌平区北七家宏福创业园修正大厦3层"/>
	</form>
...
<div class="step-cont">
	...
	<div class="consignee-item item-selected" consigneeId="137617472" id="consignee_index_div_137617472">
		<b></b>
		<div class="user-name">
			<div class="fl"><strong limit="4">张飞</strong>&nbsp;&nbsp;收</div>
			<div class="fr">158****0000</div>
			<div class="clr"></div>
		</div>
		<div class="mt10" limit="15">北京 昌平区 </div>
		<div class="adr-m" limit="30">北京市昌平区北七家宏福创业园修正大厦3层</div>
	...
	<div class="item">
		...
		<div class="fl">
			<select name="pickRegion" id="pickRegion_select" class="selt pickRegion_select" onchange="doEditPickReigon(this)">
						   ...
						   <option value="2:2824:0:0"  >西城区</option>
						   <option value="2:2830:0:0"  >东城区</option>
						   <option value="2:2834:0:0"  >朝阳区</option>
						   <option value="2:2823:0:0"  >丰台区</option>
						   <option value="2:2822:0:0"  >石景山区</option>
						   <option value="2:2919:0:0"  >海淀区</option>
						   <option value="2:2825:0:0"  >门头沟区</option>
						   <option value="2:2833:0:0"  >房山区</option>
						   <option value="2:2826:0:0"  >通州区</option>
						   <option value="2:2815:0:0"  >顺义区</option>
						   <option value="2:2817:0:0"  >昌平区</option>
						   <option value="2:2841:0:0"  >大兴区</option>
						   <option value="2:2835:0:0"  >怀柔区</option>
						   <option value="2:2820:0:0"  >平谷区</option>
						   <option value="2:2835:0:0"  >密云县</option>
						   <option value="2:2820:0:0"  >延庆县</option>
						</select>
		</div>
	</div>
	<div class="item">
...
<div class="order-summary">
    ...
    <div class="list" id="showFreeFreight"  style="display:none;" >
      <span>运费优惠：</span><em class="price" id="freeFreightPriceId"> -￥0.00</em>
		...
		<div class="list">
			<span>应付总额：</span>
			<em class="price" id="sumPayPriceId"> ￥1888.80</em>
		</div>
	</div>
		<div class="clr"></div>
	</div>
      ...
      <div class="sticky-wrap">
          ...
          <button type="submit" class="checkout-submit btn-1" id="order-submit" onclick="javascript:submit_Order();">
            提交订单<b></b>
                    ...
                    <span class="total">应付总额：<strong id="payPriceId">￥1888.80</strong>
